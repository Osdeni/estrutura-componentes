...
const App = class {
    ...
    renderMenuVertical() {
        ...
        `, onMouseOver: this.onMouseOverMenuVertical, onMouseLeave: this.onMouseLeaveMenuVertical }, h("nav", { class: "menu-vertical__body", "aria-label": "Op\u00E7\u00F5es de navega\u00E7\u00E3o do menu vertical" }, h("ul", { role: "menubar", class: "menu-vertical__list" }, this.opcoesMenu.map((opcao, index) => (h("li", { role: "none" }, h("bth-menu-vertical-item", { role: "menuitem", id: `menu_vertical_item_${index}`, key: index, identificador: opcao.id, descricao: opcao.descricao, icone: opcao.icone, contador: opcao.contador, possuiPermissao: opcao.possuiPermissao, ativo: opcao.isAtivo, recolhido: opcao.isRecolhido, menuLateralRecolhido: this.isMenuVerticalRecolhido, submenus: opcao.submenus })))))), h("div", { class: `menu-vertical__footer ${this.isDispositivoMovel ? '' : 'menu-vertical__footer--show'}` }, h("ul", { class: "menu-vertical__list" }, h("li", { class: "menu-vertical__item menu-vertical__item--floating" }, h("a", { href: "", onClick: this.onClickBotaoFixar }, h("bth-icone", { icone: "pin" }), h("span", null, this.isMenuVerticalFlutuando ? 'Fixar' : 'Desafixar')))))));
    }
    renderAppContainer() {
...
const Notificacoes = class {
    ...
    render() {
        const notificacoesConteudo = () => [
            h("div", null, !this.isApiIndisponivel && (h("bth-navbar-pill-group", { descricao: "Notifica\u00E7\u00F5es" }, this.filtros.map(filtro => (h("bth-navbar-pill-item", { key: filtro.id.toString(), identificador: filtro.id.toString(), icone: filtro.icone, descricao: filtro.descricao, ativo: filtro.ativo, totalizador: filtro.id === TipoNotificacao.NaoLida ? this.quantidadeEmNaoLidas : (filtro.id === TipoNotificacao.Progresso ? this.quantidadeEmProgressoNaoLidas : 0), showTotalizador: !this.isBuscandoNotificacoes }))))), !this.isApiIndisponivel && this.hasNotificacoes() && this.isFiltroPorNaoLidas() && !this.isBuscandoNotificacoes && (h("div", { class: "text-right" }, h("a", { class: "link", href: "", title: "Marcar todas como lidas", onClick: this.onClickMarcarTodasComoLidas }, "Marcar todas como lidas"))), h("div", { style: this.getHeightPainelNotificacoes(), class: "painel-notificacoes", onScroll: this.onContentScroll }, !this.isApiIndisponivel && !this.hasNotificacoes() && !this.isBuscandoNotificacoes && (h("div", { class: "empty-notificacoes" }, h("div", { class: "empty-notificacoes__img" }), h("h4", null, "N\u00E3o h\u00E1 notifica\u00E7\u00F5es por aqui"))), this.isApiIndisponivel && !this.isBuscandoNotificacoes && (h("div", { class: "empty-notificacoes" }, h("div", { class: "empty-notificacoes-inconsistency" }), h("h4", null, "As notifica\u00E7\u00F5es est\u00E3o temporariamente indispon\u00EDveis"))), !this.isApiIndisponivel && (h("ul", { class: "notificacoes-lista" }, this
                .getNotificacoesPorFiltroAtivo()
                .map(notificacao => (h("li", { key: notificacao.id }, h("bth-notificacao-item", { identificador: notificacao.id, tipo: this.getOpcaoFiltroAtivo().id, texto: notificacao.text, dataHora: notificacao.dateTime, origem: notificacao.source, icone: notificacao.icon, resultadoLink: notificacao.link, cancelamentoLink: notificacao.cancellationLink, acompanharLink: notificacao.trackingLink, possuiProgresso: notificacao.progress, percentualProgresso: notificacao.percentage, status: notificacao.status, prioridade: notificacao.priority })))))), this.renderLoader()))
        ];
        if (this.onlyContent)
...
const Utilitarios = class {
    ...
    render() {
        return (h("bth-menu-ferramenta", { descricao: "Utilit\u00E1rios", tituloPainelLateral: "Utilit\u00E1rios" }, h("bth-menu-ferramenta-icone", { slot: "menu_item_desktop", icone: "view-grid" }), h("bth-menu-ferramenta-icone", { slot: "menu_item_mobile", icone: "view-grid", mobile: true }), h("span", { slot: "menu_descricao_mobile", class: "descricao-mobile" }, "Utilit\u00E1rios"), h("div", { slot: "conteudo_painel_lateral", class: "painel-utilitarios" }, this.utilitarios && (h("ul", null, this.utilitarios.map((utilitario, index) => {
            return (h("li", { key: index, id: `utilitario_item_${index}` }, h("button", { onClick: (event) => this.onClick(event, utilitario), class: `
