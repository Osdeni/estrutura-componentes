...
var Ajuda = /** @class */ (function () {
    ...
    Ajuda.prototype.render = function () {
        return (h("bth-menu-ferramenta", { descricao: "Ajuda", tituloPainelLateral: "Ajuda" }, h("bth-menu-ferramenta-icone", { slot: "menu_item_desktop", icone: "help-circle" }), h("bth-menu-ferramenta-icone", { slot: "menu_item_mobile", icone: "help-circle", mobile: true }), h("span", { slot: "menu_descricao_mobile", class: "descricao-mobile" }, "Ajuda"), h("div", { slot: "conteudo_painel_lateral", class: "empty-ajuda" }, h("div", { class: "empty-ajuda__img" }), h("h4", null, "Est\u00E1 com d\u00FAvida? Acesse a ", h("a", { href: this.getCentralAjudaHome(), target: "_blank", rel: "noreferrer" }, "Central de Ajuda ", h("bth-icone", { icone: "open-in-new" }))))));
    };
    return Ajuda;
}());
Ajuda.style = ajudaCss;
var LOCAL_STORAGE_KEY = 'bth-menu:state';
var PERMISSAO_PADRAO = true;
var SLOT = {
...
var App = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.salvarEstadoLocalStorage = function () {
            try {
                var value = {
                    aberto: _this.isMenuVerticalAberto,
                    flutuando: _this.isMenuVerticalFlutuando
                };
        ...
        this.recuperarEstadoLocalStorage = function () {
            try {
        ...
        this.onMouseOverMenuVertical = function () {
            _this.cancelarTimeoutRecolhimentoMenu();
            if (_this.isDispositivoMovel) {
                return;
            }
            if (_this.isMenuVerticalAberto) {
                return;
            }
            _this.alterarEstadoRecolhimentoMenuVertical(false);
        };
        this.onMouseLeaveMenuVertical = function () {
            if (_this.isDispositivoMovel) {
                return;
            }
            if (_this.isMenuVerticalAberto && !_this.isMenuVerticalFlutuando) {
                return;
            }
            _this.cancelarTimeoutRecolhimentoMenu();
            _this.alterarEstadoRecolhimentoMenuVertical(true);
        };
        this.onMouseOverBotaoMenu = function () {
            _this.cancelarTimeoutRecolhimentoMenu();
        };
        this.onMouseLeaveBotaoMenu = function () {
            if (_this.isMenuVerticalRecolhido) {
                return;
            }
            if (_this.isMenuVerticalAberto && !_this.isMenuVerticalFlutuando) {
                return;
        ...
        this.onTogglePainelFerramentas = function (event) {
            event.preventDefault();
            _this.isPainelFerramentasDispositivoMovelAberto = !_this.isPainelFerramentasDispositivoMovelAberto;
            if (_this.isDispositivoMovel && _this.isPainelFerramentasDispositivoMovelAberto) {
                _this.isMenuVerticalAberto = false;
            }
            _this.salvarEstadoLocalStorage();
        };
        this.onClickBotaoFixar = function (event) {
            event.preventDefault();
            _this.isMenuVerticalFlutuando = !_this.isMenuVerticalFlutuando;
            _this.isMenuVerticalRecolhido = false;
            _this.isMenuVerticalAberto = true;
            _this.salvarEstadoLocalStorage();
        };
        this.onClickBotaoMenu = function (event) {
            event.preventDefault();
            if (_this.isMenuVerticalFlutuando) {
                _this.isMenuVerticalRecolhido = !_this.isMenuVerticalRecolhido;
            }
            else {
                if (!_this.isMenuVerticalRecolhido) {
                    _this.isMenuVerticalAberto = false;
                    ...
                    _this.isMenuVerticalAberto = !_this.isMenuVerticalAberto;
                }
                _this.isMenuVerticalRecolhido = !_this.isMenuVerticalRecolhido;
            }
            // Caso o menu vertical for aberto no modo responsivo fecha o painel de ferramentas
            if (_this.isDispositivoMovel && _this.isMenuVerticalFlutuando) {
                _this.isPainelFerramentasDispositivoMovelAberto = false;
            }
            _this.salvarEstadoLocalStorage();
        };
    }
    ...
    class_1.prototype.watchOpcoesChanged = function () {
    ...
    class_1.prototype.onConteudoSinalizado = function (event) {
    ...
    class_1.prototype.onPainelLateralShow = function (event) {
    ...
    class_1.prototype.onMenuHorizontalSelecionado = function (event) {
        var opcao = this.findOpcaoMenuById(event.detail.identificador);
        this.dispararEventoOpcaoSelecionada(opcao);
    };
    class_1.prototype.onMenuVerticalSelecionado = function (event) {
        var opcao = this.findOpcaoMenuById(event.detail.identificador, event.detail.identificadorPai);
        if (this.possuiSubmenus(opcao)) {
            this.opcoesMenu = this.opcoesMenu.map(function (opcaoMenu) {
    ...
    class_1.prototype.dispararEventoOpcaoSelecionada = function (opcao) {
        var eventPayload = {
            id: opcao.id,
    ...
    class_1.prototype.onChangeBanner = function () {
        var event = {
            possui: this.possuiBanner()
        };
        this.bannerAlterado.emit(event);
    };
    class_1.prototype.onChangemenuBgColor = function () {
        this.setCorBackgroundCustomizado();
    };
    /**
     ...
     */
    class_1.prototype.setMenuAtivo = function (identificador) {
     ...
     */
    class_1.prototype.setContadorMenu = function (identificador, valor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                if (this.possuiNavegacaoVertical()) {
                    this.opcoesMenu = this.opcoesMenu.map(function (opcao) {
                        opcao.contador = opcao.id === identificador ? valor : opcao.contador;
                        if (opcao.submenus !== undefined && opcao.submenus.length > 0) {
                            opcao.submenus = opcao.submenus.map(function (submenu) {
    ...
    class_1.prototype.setCorBackgroundCustomizado = function () {
        if (this.menuBgColor === undefined) {
            return;
        }
        this.el.style.setProperty('--bth-app-menu-bg-color', this.menuBgColor.toString());
    };
    class_1.prototype.possuiSlotMarcaProduto = function () {
        return this.el.querySelector("[slot=\"" + SLOT.MARCA_PRODUTO + "\"]") !== null;
    };
    class_1.prototype.possuiSlotFerramentas = function () {
        return this.el.querySelector("[slot=\"" + SLOT.FERRAMENTAS + "\"]") !== null;
    };
    class_1.prototype.possuiSlotContexto = function () {
        return this.el.querySelector("[slot=\"" + SLOT.CONTEXTO + "\"]") !== null;
    };
    class_1.prototype.possuiFerramentasSinalizadas = function () {
        var _this = this;
        var pending = Object.keys(this.ferramentasSinalizacaoPendente)
            .filter(function (key) { return _this.ferramentasSinalizacaoPendente[key]; });
        return pending.length > 0 || false;
    };
    class_1.prototype.possuiOpcoes = function () {
        return !isNill(this.opcoesMenu) && this.opcoesMenu.length > 0;
    };
    class_1.prototype.possuiBanner = function () {
        return !isNill(this.banner);
    };
    class_1.prototype.possuiNavegacaoVertical = function () {
        if (this.possuiOpcoes()) {
            return this.menuVertical || (!this.menuVertical && this.isDispositivoMovel);
        }
        return false;
    };
    class_1.prototype.possuiNavegacaoHorizontal = function () {
        return this.possuiOpcoes() && !this.menuVertical;
    };
    class_1.prototype.setEstadoInicialMenu = function () {
        this.opcoesMenu = __spreadArrays(this.opcoes);
        this.isDispositivoMovel = isDispositivoMovel();
        var estadoLocalStorage = this.recuperarEstadoLocalStorage();
        this.isPainelFerramentasDispositivoMovelAberto = false;
    ...
    class_1.prototype.marcarAtivoMenuVertical = function (id) {
        var _this = this;
        this.opcoesMenu = this.opcoesMenu.map(function (opcao) {
            opcao.isAtivo = opcao.id === id;
            if (opcao.isAtivo) {
                _this.validarPermissaoAcessarOpcaoMenu(opcao);
            }
            if (_this.possuiSubmenus(opcao)) {
                opcao.submenus = opcao.submenus.map(function (submenu) {
                    submenu.isAtivo = submenu.id === id;
                    if (submenu.isAtivo) {
                        _this.validarPermissaoAcessarOpcaoMenu(submenu);
                    }
                    if (submenu.isAtivo) {
                        opcao.isAtivo = true;
                    }
                ...
                opcao.isRecolhido = opcao.submenus.filter(function (submenu) { return submenu.isAtivo; }).length <= 0;
            }
            return opcao;
        });
    };
    class_1.prototype.marcarAtivoMenuHorizontal = function (id) {
        var _this = this;
        this.opcoesMenu = this.opcoesMenu.map(function (opcao) {
            opcao.isAtivo = opcao.id === id;
            if (opcao.isAtivo) {
    ...
    class_1.prototype.findOpcaoMenuById = function (identificador, identificadorPai) {
        if (identificadorPai === void 0) { identificadorPai = null; }
        if (!isNill(identificadorPai)) {
            var menuPai = this.opcoesMenu.find(function (opcaoMenu) { return opcaoMenu.id === identificadorPai; });
            if (!isNill(menuPai)) {
                return menuPai.submenus.find(function (submenu) { return submenu.id === identificador; });
            }
        }
        return this.opcoesMenu.find(function (opcaoMenu) { return opcaoMenu.id === identificador; });
    };
    class_1.prototype.possuiSubmenus = function (opcao) {
        return !isNill(opcao.submenus) && opcao.submenus.length > 0;
    };
    class_1.prototype.validarPermissaoAcessarOpcaoMenu = function (opcao) {
        if ('possuiPermissao' in opcao && !opcao.possuiPermissao) {
            throw new Error(MSG_SEM_PERMISSAO_RECURSO);
        }
    };
    class_1.prototype.cancelarTimeoutRecolhimentoMenu = function () {
        if (this.timeoutAtivoHandler !== undefined) {
            clearTimeout(this.timeoutAtivoHandler);
            this.timeoutAtivoHandler = undefined;
        }
    };
    class_1.prototype.alterarEstadoRecolhimentoMenuVertical = function (isMenuVerticalRecolhido) {
        var _this = this;
        this.timeoutAtivoHandler = window.setTimeout(function () {
            _this.isMenuVerticalRecolhido = isMenuVerticalRecolhido;
            _this.timeoutAtivoHandler = undefined;
        }, TIMEOUT_INTERACOES);
    };
    class_1.prototype.renderBannerSection = function () {
        return (h("header", { role: "banner", class: "banner " + (this.possuiBanner() ? " banner--show banner--" + this.banner.tipo : ''), "aria-hidden": "" + !this.possuiBanner(), "aria-expanded": "" + this.possuiBanner() }, this.possuiBanner() && ([
            h("div", { class: "banner__icon" }, h("bth-icone", { icone: this.banner.tipo === 'info' ? 'information' : 'alert' })),
            h("div", { class: "banner__content" }, h("span", null, this.banner.texto), h("a", { href: this.banner.link, target: "_blank", title: "Mais informa\u00E7\u00F5es", rel: "noreferrer" }, "Mais informa\u00E7\u00F5es"))
        ])));
    };
    class_1.prototype.renderMenuHorizontal = function () {
        return (h("section", { class: "menu-horizontal" }, h("div", { class: "menu-horizontal__body" }, h("div", { class: "menu-horizontal__list" }, this.possuiNavegacaoVertical() && (h("div", { class: "menu-horizontal__item" }, h("a", { role: "button", href: "", class: "menu-vertical__toggle " + (!this.isMenuVerticalRecolhido ? 'menu-vertical__toggle--opened' : ''), title: "Alternar exibi\u00E7\u00E3o do menu lateral", onClick: this.onClickBotaoMenu, onMouseLeave: this.onMouseLeaveBotaoMenu, onMouseOver: this.onMouseOverBotaoMenu, "aria-expanded": "" + !this.isMenuVerticalRecolhido, "aria-pressed": "" + !this.isMenuVerticalRecolhido, "aria-label": "Alternar exibi\u00E7\u00E3o do menu lateral" }))), this.possuiSlotMarcaProduto() && (h("section", { class: "menu-horizontal__item" }, h("slot", { name: SLOT.MARCA_PRODUTO }))), h("nav", { id: "menu_horizontal_list", class: "menu-horizontal__item menu-horizontal__item--has-list", "aria-label": "Navega\u00E7\u00E3o do menu horizontal", "aria-hidden": "" + !this.possuiNavegacaoHorizontal() }, this.possuiNavegacaoHorizontal() && (h("ul", { role: "menubar", class: "menu-horizontal__list", "aria-label": "Navega\u00E7\u00E3o do menu horizontal" }, this.possuiNavegacaoHorizontal() && this.opcoesMenu.map(function (opcao, index) { return (h("li", { role: "none" }, h("bth-menu-horizontal-item", { role: "menuitem", id: "menu_horizontal_item_" + index, key: index, identificador: opcao.id, descricao: opcao.descricao, contador: opcao.contador, possuiPermissao: opcao.possuiPermissao, ativo: opcao.isAtivo }))); })))), h("section", { class: "menu-horizontal__item" }, h("nav", { class: "menu-ferramentas" }, !this.isDispositivoMovel && (h("slot", { name: SLOT.FERRAMENTAS })), this.isDispositivoMovel && this.possuiSlotFerramentas() && (h("li", { role: "none" }, h("a", { role: "button", href: "", class: "menu-ferramentas__mobile-toggler " + (this.isPainelFerramentasDispositivoMovelAberto ? 'menu-ferramentas__mobile-toggler--opened' : ''), onClick: this.onTogglePainelFerramentas, title: "Alternar exibi\u00E7\u00E3o painel de ferramentas", "aria-expanded": "" + this.isPainelFerramentasDispositivoMovelAberto, "aria-pressed": "" + this.isPainelFerramentasDispositivoMovelAberto, "aria-label": "Alternar exibi\u00E7\u00E3o painel de ferramentas" }, this.possuiSinalizacaoPendente && !this.isPainelFerramentasDispositivoMovelAberto && (h("span", { class: "badge badge-danger badge-danger--notificacao-small" })))))))), this.isDispositivoMovel && (h("nav", { class: "menu-ferramentas__mobile\n                  " + (this.isPainelFerramentasDispositivoMovelAberto ? 'menu-ferramentas__mobile--show' : '') + "\n                  " + (this.possuiBanner() ? 'menu-ferramentas__mobile--banner' : '') }, h("slot", { name: SLOT.FERRAMENTAS }))))));
    };
    class_1.prototype.renderMenuVertical = function () {
        var _this = this;
        if (!this.possuiNavegacaoVertical()) {
            return;
        }
        return (h("aside", { class: "menu-vertical " + (this.isMenuVerticalFlutuando ? ' menu-vertical--floating' : '') + "\n          " + (this.isMenuVerticalRecolhido ? ' menu-vertical--collapsed' : '') + "\n          " + (!this.isMenuVerticalFlutuando && !this.isMenuVerticalAberto && !this.isMenuVerticalRecolhido ? ' menu-vertical--collapsed menu-vertical--collapsed-hover' : '') + "\n        ", onMouseOver: this.onMouseOverMenuVertical, onMouseLeave: this.onMouseLeaveMenuVertical }, h("nav", { class: "menu-vertical__body", "aria-label": "Op\u00E7\u00F5es de navega\u00E7\u00E3o do menu vertical" }, h("ul", { role: "menubar", class: "menu-vertical__list" }, this.opcoesMenu.map(function (opcao, index) { return (h("li", { role: "none" }, h("bth-menu-vertical-item", { role: "menuitem", id: "menu_vertical_item_" + index, key: index, identificador: opcao.id, descricao: opcao.descricao, icone: opcao.icone, contador: opcao.contador, possuiPermissao: opcao.possuiPermissao, ativo: opcao.isAtivo, recolhido: opcao.isRecolhido, menuLateralRecolhido: _this.isMenuVerticalRecolhido, submenus: opcao.submenus }))); }))), h("div", { class: "menu-vertical__footer " + (this.isDispositivoMovel ? '' : 'menu-vertical__footer--show') }, h("ul", { class: "menu-vertical__list" }, h("li", { class: "menu-vertical__item menu-vertical__item--floating" }, h("a", { href: "", onClick: this.onClickBotaoFixar }, h("bth-icone", { icone: "pin" }), h("span", null, this.isMenuVerticalFlutuando ? 'Fixar' : 'Desafixar')))))));
    };
    class_1.prototype.renderAppContainer = function () {
        return (h("main", { class: "app-container" }, this.possuiSlotContexto() && !this.isDispositivoMovel && (h("slot", { name: SLOT.CONTEXTO })), h("slot", { name: SLOT.APLICACAO })));
    };
    class_1.prototype.render = function () {
        return (h(Host, null, h("div", { class: "app" }, this.renderBannerSection(), this.renderMenuHorizontal(), this.renderMenuVertical(), this.renderAppContainer())));
    };
...
var Avatar = /** @class */ (function () {
    function Avatar(hostRef) {
         ...
         */
        this.bordaCor = 'white';
        this.onImageLoadError = function (event) {
            _this.imageLoadError.emit(event);
        };
    }
    Avatar.prototype.getSiglaIniciais = function (texto) {
        var _a;
        if (texto.length <= 2) {
            return texto.toUpperCase();
        }
        var palavras = texto.replace(/[^\w\s]/gi, '').split(' ');
        var iniciais = palavras.filter(function (palavra) { return Boolean(palavra); })
            .map(function (palavra) { return palavra.substr(0, 1); });
        return iniciais[0].concat((_a = iniciais[1]) !== null && _a !== void 0 ? _a : '').toUpperCase();
    };
    Avatar.prototype.getColorClass = function () {
        if (this.icone !== undefined) {
            return 'avatar-icone bg-blue tx-blue';
        }
        if (this.iniciais !== undefined) {
            var color = this.getCorInicias();
            return "bg-" + color + " tx-" + color;
        }
        return '';
    };
    Avatar.prototype.getSizeClass = function () {
    ...
    Avatar.prototype.getRoundingClass = function () {
        if (this.quadrado) {
            return 'avatar-square';
        }
        return '';
    };
    Avatar.prototype.getCorInicias = function () {
        return BG_COLORS[this.iniciais.charCodeAt(0) % BG_COLORS.length];
    };
    Avatar.prototype.getContainerCustomStyles = function () {
        var containerStyles = {};
    ...
    Avatar.prototype.getImagemCustomStyles = function () {
        var imagemStyles = {};
    ...
    Avatar.prototype.render = function () {
        return (h(Host, null, h("div", { class: "avatar__container" }, h("figure", { class: "avatar__body " + this.getRoundingClass() + " " + this.getColorClass() + " " + this.getSizeClass(), style: this.getContainerCustomStyles() }, this.icone && (h("bth-icone", { icone: this.icone, cor: getCssVariableValue('--bth-app-gray-light-40') })), this.src && (h("img", { src: this.src, class: "avatar--imagem " + this.getRoundingClass() + " " + this.getSizeClass(), style: this.getImagemCustomStyles(), alt: this.el.getAttribute('title') || 'Avatar', onError: this.onImageLoadError })), this.iniciais && (h("span", null, this.getSiglaIniciais(this.iniciais)))), this.subIcone && (h("bth-icone", { class: "subicone", icone: this.subIcone, title: this.subIconeTitle })))));
    };
    Object.defineProperty(Avatar.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
...
var ContaUsuario = /** @class */ (function () {
    ...
    class_2.prototype.getCentralUsuarioHome = function () {
    ...
    class_2.prototype.getUrlImagemPerfil = function () {
        if (isNill(this.fotoUrl) || this.erroCarregarFotoAvatar) {
            return DEFAULT_AVATAR_URL;
        }
        return this.fotoUrl;
    };
    class_2.prototype.renderMenuItemMobile = function () {
        return (h("div", { slot: "menu_item_mobile" }, h("bth-avatar", { class: "avatar-mobile", src: this.getUrlImagemPerfil(), title: "Foto de " + this.nome, dimensao: 54, borda: true, bordaTamanho: "2px", bordaCor: getCssVariableValue('--bth-app-blue'), bordaRaio: "50%", onImageLoadError: this.onImageLoadError }), h("div", { class: "avatar-mobile-badge" }, h("bth-icone", { icone: "cog" }))));
    };
    class_2.prototype.renderMenuDescricaoMobile = function () {
        return (h("section", { slot: "menu_descricao_mobile", class: "perfil-usuario" }, h("div", null, h("span", { class: "perfil-usuario__nome", title: this.nome }, this.nome), h("span", { class: "perfil-usuario__id", title: "@" + this.usuario }, "@", this.usuario))));
    };
    class_2.prototype.renderMenuItemDesktop = function () {
        return (h("section", { slot: "menu_item_desktop" }, h("bth-avatar", { class: "avatar-desktop", src: this.getUrlImagemPerfil(), title: "Foto de " + this.nome, tamanho: "menor", borda: true, bordaTamanho: "2px", bordaCor: getCssVariableValue('--bth-app-gray-light-10'), bordaRaio: "50%", onImageLoadError: this.onImageLoadError })));
    };
    class_2.prototype.renderConteudoPainelLateral = function () {
        return (h("section", { slot: "conteudo_painel_lateral", class: "painel-usuario" }, h("div", { class: "perfil-usuario" }, h("bth-avatar", { src: this.getUrlImagemPerfil(), title: "Foto de " + this.nome, dimensao: 120, borda: true, bordaTamanho: "2px", bordaCor: getCssVariableValue('--bth-app-blue'), bordaRaio: "50%", onImageLoadError: this.onImageLoadError }), h("div", null, h("span", { class: "perfil-usuario__nome", title: this.nome }, this.nome), h("span", { class: "perfil-usuario__id", title: "@" + this.usuario }, "@", this.usuario))), h("ul", null, h("li", null, h("a", { href: this.getCentralUsuarioHome(), target: "_blank", title: "Editar", rel: "noreferrer" }, h("bth-icone", { icone: "pencil" }), " Editar")), h("li", null, h("a", { href: "", title: "Sair", onClick: this.onLogout }, h("bth-icone", { icone: "login-variant" }), " Sair")))));
    };
    class_2.prototype.render = function () {
        return (h("bth-menu-ferramenta", { descricao: "Conta do usu\u00E1rio" }, this.renderMenuItemMobile(), this.renderMenuDescricaoMobile(), this.renderMenuItemDesktop(), this.renderConteudoPainelLateral()));
    };
...
var Icone = /** @class */ (function () {
    ...
    Icone.prototype.connectedCallback = function () {
        this.carregarIcone();
    };
    Icone.prototype.carregarIcone = function () {
        if (isNill(this.icone)) {
            return;
        }
        var label = this.icone.replace(/-/, ' ');
        this.ariaLabel = this.ariaLabel || label;
    };
    Icone.prototype.render = function () {
        return (h(Host, { role: "img" }, h("i", { class: "mdi mdi-" + this.icone, style: { 'font-size': this.tamanho, 'color': this.cor } })));
    };
    Object.defineProperty(Icone, "watchers", {
        get: function () {
            return {
                "icone": ["carregarIcone"]
            };
...
var Loader = /** @class */ (function () {
    ...
    Loader.prototype.render = function () {
        return (h("div", { class: "loader " + (this.inline ? 'loader--inline' : '') }, h("div", { class: "dot" }), h("div", { class: "dot" }), h("div", { class: "dot" })));
    };
    return Loader;
}());
...
var isValidAuthorizationConfig = function (authorization) {
...
var Api = /** @class */ (function () {
    function Api(authorization, handleUnauthorizedAccess, baseUrl) {
        this.authorization = authorization;
        this.handleUnauthorizedAccess = handleUnauthorizedAccess;
        this.baseUrl = baseUrl;
    }
    Api.prototype.request = function (method, path, retryUnauthorizedAccess) {
        if (retryUnauthorizedAccess === void 0) { retryUnauthorizedAccess = true; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, fetch(this.baseUrl + "/" + path, { method: method, headers: this.getHeaders() })];
                    case 1:
                        response = _f.sent();
                        if (!(response.status === UNAUTHORIZED_STATUS_CODE && retryUnauthorizedAccess && this.handleUnauthorizedAccess !== undefined)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.handleUnauthorizedAccess()];
                    case 2:
                        _f.sent();
                        return [4 /*yield*/, this.request(method, path, false)];
...
var MarcaProduto = /** @class */ (function () {
    function class_3(hostRef) {
        ...
        this.onMouseOverMenuProduto = function () {
            if (_this.isDispositivoMovel) {
                return;
            }
            _this.cancelarTimeoutAtivo();
            _this.alterarEstadoAberto(true);
        };
        this.onMouseLeaveMenuProduto = function () {
            if (_this.isDispositivoMovel) {
                return;
            }
            _this.cancelarTimeoutAtivo();
            _this.alterarEstadoAberto(false);
        };
        this.onMouseOverToggleProduto = function () {
            if (_this.isDispositivoMovel) {
                return;
            }
            _this.cancelarTimeoutAtivo();
        };
        this.onToggleAberto = function () {
            _this.cancelarTimeoutAtivo();
            if (!_this.exibirProdutos) {
                return;
            }
            if (_this.isDispositivoMovel && _this.isDropdownProdutosAberto) {
                return;
            }
            _this.isDropdownProdutosAberto = !_this.isDropdownProdutosAberto;
        };
        this.onClickFechar = function (event) {
            event.stopPropagation();
            event.preventDefault();
            _this.isDropdownProdutosAberto = false;
        };
        this.openLink = function (event, url) {
            event.preventDefault();
            window.open(url, '_blank');
        };
        this.getClassPorLinhaProduto = function (product) {
            var _a, _b;
    ...
    class_3.prototype.onWindowResize = function () {
        this.configurarPropriedadesResponsivas();
    };
    class_3.prototype.watchExibirProdutos = function (novoValor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                if (novoValor) {
                    this.buscarProdutos();
    ...
    class_3.prototype.buscarProdutos = function () {
        return __awaiter(this, void 0, void 0, function () {
            var authorization, UserAccountsApi, promise;
            var _this = this;
            return __generator(this, function (_f) {
                ...
                UserAccountsApi = new Api(authorization, this.authorization.handleUnauthorizedAccess, this.getUserAccountsApi() + "/api");
                promise = UserAccountsApi.request('GET', "access/" + authorization.accessId + "/systems")
                    .then(function (produtos) {
                    _this.produtos = produtos.filter(function (produto) { return produto.id !== authorization.systemId; });
                })
                    .catch(function () {
                    _this.isApiIndisponivel = true;
                });
    ...
    class_3.prototype.getSuiteHome = function () {
        var _a, _b, _c, _d, _e;
    ...
    class_3.prototype.getStoreHome = function () {
        var _a, _b, _c, _d, _e;
    ...
    class_3.prototype.getUserAccountsApi = function () {
        var _a, _b, _c, _d, _e;
    ...
    class_3.prototype.isConfiguracaoApiInconsistente = function () {
    ...
    class_3.prototype.configurarPropriedadesResponsivas = function () {
        this.isDispositivoMovel = isDispositivoMovel();
    };
    class_3.prototype.cancelarTimeoutAtivo = function () {
        if (this.activeTimeoutHandler !== undefined) {
            clearTimeout(this.activeTimeoutHandler);
            this.activeTimeoutHandler = undefined;
        }
    };
    class_3.prototype.alterarEstadoAberto = function (opened) {
        var _this = this;
        this.activeTimeoutHandler = window.setTimeout(function () {
            _this.isDropdownProdutosAberto = opened;
            _this.activeTimeoutHandler = undefined;
        }, TIMEOUT_INTERACOES);
    };
    class_3.prototype.render = function () {
        var _this = this;
        var contemProdutos = this.produtos && this.produtos.length > 0;
        return (h("section", { class: "marca-produto " + (this.isDropdownProdutosAberto ? 'marca-produto--active' : ''), onClick: this.onToggleAberto, onMouseLeave: this.onMouseLeaveMenuProduto, onMouseOver: this.onMouseOverToggleProduto, "aria-expanded": "" + this.isDropdownProdutosAberto, "aria-controls": "marca_produto_detalhes" }, h("header", { id: "produto_description", title: this.produto }, this.produto), this.exibirProdutos && (h("div", { id: "marca_produto_detalhes", class: "marca-produto__detalhes " + (this.isDropdownProdutosAberto ? 'marca-produto__detalhes--show' : ''), onMouseOver: this.onMouseOverMenuProduto, onMouseLeave: this.onMouseLeaveMenuProduto, "aria-hidden": "" + !this.isDropdownProdutosAberto, "aria-labelledby": "produto_description", role: "region" }, h("div", { class: "marca-produto__detalhes-solucoes" }, h("div", { class: "marca-produto__detalhes-solucoes__header" }, h("h4", null, "Mais produtos"), contemProdutos && (h("a", { href: this.getSuiteHome(), target: "_blank", title: "Ver todos", rel: "noreferrer" }, "Ver todos")), this.isDispositivoMovel && (h("button", { onClick: this.onClickFechar }, h("bth-icone", { icone: "close" })))), h("div", { class: "marca-produto__detalhes-solucoes__body" }, h("div", { class: "loader-wrapper " + (this.isBuscandoProdutos ? 'loader-wrapper--show' : '') }, h("bth-loader", null)), !this.isBuscandoProdutos && !this.isApiIndisponivel && contemProdutos && (h("ul", { class: "marca-produto__detalhes-solucoes__list" }, this.produtos && this.produtos.map(function (produto, index) {
            return (h("li", { key: index, id: "marca_produto_item_" + produto.id }, h("button", { class: "marca-produto__detalhes-card marca-produto__detalhes-card--bordered marca-produto__detalhes-card--clickable", onClick: function (event) { return _this.openLink(event, produto.url); } }, h("div", { class: "marca-produto__detalhes-card__body" }, h("div", { class: "marca-produto__detalhes__brand " + _this.getClassPorLinhaProduto(produto) }, h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 231.73 251.78" }, h("defs", null), h("title", null, produto.name), h("g", { "data-name": "Camada 2" }, h("g", { "data-name": "Camada 1" }, h("path", { class: "cls-1", d: "M182.83,119.72c3.06,1.55,4.76,2.35,6.4,3.25,4.64,2.57,9.47,4.88,13.85,7.84,16.93,11.42,23.41,27.41,20.69,47.56-4,29.37-21.21,48.42-46.92,60.86-17.92,8.66-37.1,12.31-56.87,12.43-37.93.22-75.86.07-113.8.05-1.88,0-3.77-.27-6.18-.46,2.13-12.49,4.15-24.59,6.26-36.67Q18.32,145.39,30.42,76.2c3.29-18.77,6.72-37.53,9.82-56.33.6-3.67,2-5.29,5.63-6.24a388,388,0,0,1,60.5-11C121,1.23,135.74.29,150.44,0a106,106,0,0,1,39.06,6.7c9.61,3.57,18.4,8.49,25.75,15.74,20.84,20.56,22.11,55.65,2.68,76.07-7.27,7.64-16.21,12.89-25.83,17C189.47,116.71,186.93,117.9,182.83,119.72ZM62.14,210.82c2.25.24,3.66.52,5.07.52,19.32,0,38.65.23,58-.12a57.2,57.2,0,0,0,16.3-2.92c18.25-5.94,28.91-23.37,26.44-42.41-1.45-11.13-7.89-18.63-18.88-21.18A67,67,0,0,0,134.69,143c-17.87-.2-35.75-.1-53.62-.06-2.1,0-4.19.3-6.76.5ZM92.14,43C88.81,54.18,82,97.74,82.75,103.3a16.68,16.68,0,0,0,2.71.46c17.16,0,34.33.38,51.48-.08,11.23-.3,21-4.77,29.08-12.91,9-9.13,11.51-19.84,8-32-3.34-11.61-12.07-17-23.25-19.13-19.91-3.74-39.34.53-58.66,3.32Z" }))))), h("div", { class: "marca-produto__detalhes__name block-text--hidden", title: produto.name }, produto.name)))));
        }))), !this.isBuscandoProdutos && !contemProdutos && (h("div", { class: "empty-state-container" }, !this.isApiIndisponivel && ([
            h("div", { class: "empty-list-store" }),
            h("h3", null, "Conhe\u00E7a outros produtos dispon\u00EDveis. Acesse os ", h("a", { href: this.getStoreHome() + "/#/pesquisa?identificador=TIPO&coluna=plataforma.chave&valor=web", target: "_blank", rel: "noreferrer" }, " sistemas da entidade"), " ou", h("a", { href: this.getStoreHome() + "/#/pesquisa?identificador=TIPO&coluna=plataforma.chave&valor=web", target: "_blank", rel: "noreferrer" }, " explore mais solu\u00E7\u00F5es na Betha Store ", h("bth-icone", { icone: "open-in-new" })))
...
var MenuFerramenta = /** @class */ (function () {
    function class_4(hostRef) {
         ...
         */
        this.descricao = '';
        this.onToggleEstadoAberto = function (event) {
            event.preventDefault();
            _this.alternarExibicaoPainelLateral();
        };
        this.onPainelLateralShow = function (event) {
            if (_this.isDispositivoMovel) {
                return;
            }
            var desktopToggler = _this.el.shadowRoot.querySelector('.ferramenta-menu__desktop-toggler');
        ...
        this.onMouseOverToggle = function () {
            var painelLateral = _this.el.shadowRoot.querySelector('bth-menu-painel-lateral');
            painelLateral.cancelarAberturaComAnimacao();
        };
        this.onMouseLeaveToggle = function () {
            var painelLateral = _this.el.shadowRoot.querySelector('bth-menu-painel-lateral');
    ...
    class_4.prototype.onWindowResize = function () {
        this.configurarPropriedadesResponsivas();
    };
    /**
     * Fecha os paineis abertos
     */
    class_4.prototype.fecharPaineisAbertos = function () {
        return __awaiter(this, void 0, void 0, function () {
            var painelLateral;
            return __generator(this, function (_f) {
                painelLateral = this.el.shadowRoot.querySelector('bth-menu-painel-lateral');
    ...
    class_4.prototype.configurarPropriedadesResponsivas = function () {
        this.isDispositivoMovel = isDispositivoMovel();
    ...
    class_4.prototype.alternarExibicaoPainelLateral = function () {
        var painelLateral = this.el.shadowRoot.querySelector('bth-menu-painel-lateral');
        if (painelLateral === null) {
            return;
        }
    ...
    class_4.prototype.render = function () {
        if (!this.possuiConteudoPainelLateralDeclarado) {
            return (h(Host, null, h("div", { class: "ferramenta-menu__desktop-toggler", title: this.descricao, "aria-haspopup": "false" }, h("slot", { name: SLOT$1.MENU_ITEM_DESKTOP }))));
        }
        return (h(Host, null, this.isDispositivoMovel && this.possuiMenuItemMobileDeclarado && (h("div", { class: "ferramenta-menu__mobile-toggler", title: this.descricao, "aria-haspopup": "true" }, h("a", { href: "", onClick: this.onToggleEstadoAberto, "aria-label": "Acessar o painel da ferramenta de " + this.descricao }, h("slot", { name: SLOT$1.MENU_ITEM_MOBILE }), h("slot", { name: SLOT$1.MENU_DESCRICAO_MOBILE })))), !this.isDispositivoMovel && this.possuiMenuItemDesktopDeclarado && (h("div", { class: "ferramenta-menu__desktop-toggler", title: this.descricao, "aria-haspopup": "true" }, h("a", { href: "", onClick: this.onToggleEstadoAberto, onMouseLeave: this.onMouseLeaveToggle, onMouseOver: this.onMouseOverToggle, "aria-label": "Acessar o painel da ferramenta de " + this.descricao }, h("slot", { name: SLOT$1.MENU_ITEM_DESKTOP })))), h("bth-menu-painel-lateral", { onPainelLateralShow: this.onPainelLateralShow, titulo: this.tituloPainelLateral }, h("slot", { name: SLOT$1.CONTEUDO_PAINEL_LATERAL }))));
    };
...
var MenuPainelLateral = /** @class */ (function () {
    function class_5(hostRef) {
         ...
         */
        this.show = false;
        this.onToggleShow = function (event) {
            event.stopPropagation();
            _this.show = !_this.show;
        };
        this.onCloseAll = function (event) {
            event.stopPropagation();
            _this.dispatchFecharTodosEvent();
            _this.show = !_this.show;
        };
        this.onMouseOver = function () {
            ...
            _this.cancelarAberturaComAnimacao();
            _this.setShowComAnimacao(true);
        };
        this.onMouseLeave = function () {
            ...
            _this.cancelarAberturaComAnimacao();
            _this.setShowComAnimacao(false);
        };
    }
    class_5.prototype.showHandler = function () {
    ...
    class_5.prototype.onWindowResize = function () {
        this.configurarPropriedadesResponsivas();
        this.setShowComAnimacao(false);
    };
    class_5.prototype.onBannerAlterado = function (event) {
        this.menuPossuiBanner = event.detail.possui;
    };
    class_5.prototype.onPainelLateralShow = function (event) {
     ...
     */
    class_5.prototype.setShowComAnimacao = function (show) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_f) {
                this.timeoutAtivoHandler = window.setTimeout(function () {
     ...
     */
    class_5.prototype.cancelarAberturaComAnimacao = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                if (this.timeoutAtivoHandler === undefined) {
                    return [2 /*return*/];
     ...
     */
    class_5.prototype.fecharPaineisAbertos = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
    ...
    class_5.prototype.watchShow = function (novoValor) {
        var _this = this;
        if (novoValor) {
            this.renderSlot = this.show;
        }
        else {
            setTimeout(function () { return _this.renderSlot = _this.show; }, TIMEOUT_INTERACOES);
        }
    };
    class_5.prototype.dispatchFecharTodosEvent = function () {
    ...
    class_5.prototype.configurarPropriedadesResponsivas = function () {
        this.isDispositivoMovel = isDispositivoMovel();
    };
    class_5.prototype.render = function () {
        var _a;
        return (h(Host, { "aria-hidden": "" + !this.show, "aria-expanded": "" + this.show, "aria-label": "" + ((_a = this.titulo) !== null && _a !== void 0 ? _a : 'Painel lateral') }, h("div", { class: "painel-lateral " + (this.menuPossuiBanner ? 'painel-lateral--banner' : '') + " " + (this.show ? 'painel-lateral--show' : ''), onMouseLeave: this.onMouseLeave, onMouseOver: this.onMouseOver, "aria-hidden": "" + !this.show, "aria-expanded": "" + this.show }, h("header", null, h("button", { class: "btn-back", onClick: this.onToggleShow, title: "Voltar" }, h("bth-icone", { icone: "arrow-left" })), this.titulo && (h("h3", null, this.titulo)), h("button", { class: "btn-close", onClick: this.onCloseAll, title: "Fechar todos" }, h("bth-icone", { icone: "close" }))), this.renderSlot && (h("slot", null, "Conte\u00FAdo painel lateral")))));
    };
...
var MenuVerticalItem = /** @class */ (function () {
    function MenuVerticalItem(hostRef) {
        ...
        this.onClick = function (event) {
            ...
            _this.menuVerticalSelecionado.emit({
                identificador: _this.identificador,
                identificadorPai: _this.identificadorPai
            });
        };
    }
    MenuVerticalItem.prototype.render = function () {
        var _this = this;
        var possuiSubmenus = !isNill(this.submenus) && this.submenus.length > 0;
        return (h("div", { class: "\n          menu-vertical__item\n          " + (this.ativo ? ' menu-vertical__item--active' : '') + "\n          " + (possuiSubmenus ? ' menu-vertical__item--has-children' : '') + "\n          " + ((this.recolhido || this.menuLateralRecolhido) ? ' menu-vertical__item--collapsed' : '') + "\n          " + (this.submenu ? 'menu-vertical__submenu' : '') + "\n        " }, h("a", { href: "", onClick: this.onClick, class: "" + (!possuiSubmenus && !this.possuiPermissao ? 'menu-vertical__item--disabled' : ''), title: "" + (!this.possuiPermissao ? MSG_SEM_PERMISSAO_RECURSO : this.descricao), "aria-haspopup": "" + possuiSubmenus, "aria-expanded": "" + (possuiSubmenus && !(this.recolhido || this.menuLateralRecolhido)), "aria-disabled": "" + !this.possuiPermissao, "aria-label": possuiSubmenus ? "Expandir " + this.descricao : "Navegar para " + this.descricao, tabindex: this.possuiPermissao ? 0 : -1 }, this.icone && (h("bth-icone", { icone: this.icone })), h("span", { class: "" + (isNill(this.icone) && !this.submenu ? 'menu-vertical__item--sem-icone' : ''), title: "" + (!this.possuiPermissao ? MSG_SEM_PERMISSAO_RECURSO : this.descricao) }, this.descricao), h(BadgeContador, { valor: this.contador, customClass: this.menuLateralRecolhido ? 'badge-vertical-floating' : '' }), possuiSubmenus && (h("bth-icone", { icone: "chevron-up" }))), possuiSubmenus && (h("ul", { class: "menu-vertical__list" }, this.submenus.map(function (submenu, index) {
            var _a;
            return (h("li", null, h("bth-menu-vertical-item", { id: "menu_vertical_subitem_" + index, key: index, identificador: submenu.id, "identificador-pai": _this.identificador, descricao: submenu.descricao, icone: submenu.icone, onMenuVerticalSelecionado: _this.onClick, contador: submenu.contador, possuiPermissao: (_a = submenu.possuiPermissao) !== null && _a !== void 0 ? _a : PERMISSAO_PADRAO, ativo: submenu.isAtivo, recolhido: submenu.isRecolhido, menuLateralRecolhido: _this.menuLateralRecolhido, submenus: submenu.submenus, submenu: true })));
        })))));
    };
    return MenuVerticalItem;
}());
MenuVerticalItem.style = menuVerticalItemCss;
var navbarPillGroupCss = ":host{display:block}.navbar-pill-group{display:-ms-flexbox;display:flex;padding-left:0;margin-bottom:12px;text-align:center;list-style-type:none}::slotted(bth-navbar-pill-item){-ms-flex:1;flex:1;border:0.5px solid var(--bth-app-gray-light-10);font-size:14px}::slotted(bth-navbar-pill-item[ativo]){-ms-flex:2;flex:2}";
var NavbarPillGroup = /** @class */ (function () {
    function NavbarPillGroup(hostRef) {
        registerInstance(this, hostRef);
    }
    NavbarPillGroup.prototype.render = function () {
        var _a;
        return (h("nav", { "aria-label": "Navega\u00E7\u00E3o por filtros " + ((_a = this.descricao) === null || _a === void 0 ? void 0 : _a.toLowerCase()) }, h("div", { class: "navbar-pill-group", role: "menubar" }, h("slot", null))));
    };
    return NavbarPillGroup;
}());
NavbarPillGroup.style = navbarPillGroupCss;
var navbarPillItemCss = "*,*:after,*:before{padding:0;margin:0;-webkit-box-sizing:border-box;box-sizing:border-box;line-height:1.5}*{font-family:var(--bth-app-font-family-primary)}a:focus{outline:1px dotted var(--bth-app-gray-dark-30)}::-webkit-scrollbar{-webkit-appearance:none;height:6px;width:6px}::-webkit-scrollbar-track{background:var(--bth-app-gray-light-30)}::-webkit-scrollbar-corner{background:var(--bth-app-gray-light-40)}::-webkit-scrollbar-thumb{background-color:var(--bth-app-gray);border-radius:1px}::-webkit-scrollbar-thumb:hover{background-color:rgba(255, 255, 255, 0.3)}.navbar-pill-item{white-space:nowrap}.navbar-pill-item--active a{background-color:var(--bth-app-gray-light-10)}.navbar-pill-item:first-child{border-radius:2px 0px 0px 2px;border-right:none}.navbar-pill-item:last-child{border-radius:0px 2px 2px 0px;border-left:none}.navbar-pill-item a{display:block;text-decoration:none;color:var(--bth-app-gray-dark-30);padding:4px 0px}.navbar-pill-item a i{font-size:16px}.navbar-pill-item a:hover{background-color:var(--bth-app-gray-light-20)}.navbar-pill-item a>span{margin:0px 0px 0px 6px}.navbar-pill-item a .descricao{display:none;opacity:0}.navbar-pill-item a .descricao--show{opacity:1;display:inline-block}.navbar-pill-item a .totalizador{color:var(--bth-app-gray-dark-20);font-size:13px;margin:0px 0px 0px 4px}";
var NavbarPillItem = /** @class */ (function () {
    function NavbarPillItem(hostRef) {
        var _this = this;
        registerInstance(this, hostRef);
        this.navbarPillItemClicked = createEvent(this, "navbarPillItemClicked", 7);
        /**
         * Está ativo?
         */
        this.ativo = false;
        ...
        this.onClick = function (event) {
            event.preventDefault();
            _this.navbarPillItemClicked.emit({
                identificador: _this.identificador
            });
        };
    }
    NavbarPillItem.prototype.render = function () {
        return (h("div", { role: "menuitem", class: "navbar-pill-item " + (this.ativo ? 'navbar-pill-item--active' : '') }, h("a", { href: "", title: this.descricao, onClick: this.onClick }, h("bth-icone", { icone: this.icone }), h("span", { class: "descricao " + (this.ativo ? 'descricao--show' : '') }, this.descricao), this.showTotalizador && this.totalizador !== 0 && (h("span", { class: "totalizador" }, "(", this.totalizador, ")")))));
    };
    return NavbarPillItem;
}());
...
function getDataHoraDescrita(dateTime) {
    ...
    if (isHoje(data, dataAgora)) {
        if (!isMesmaHora(data, dataAgora)) {
            var horas = getDiferencaEmHoras(data, dataAgora);
        ...
        if (!isMesmoMinuto(data, dataAgora)) {
            var minutos = getDiferencaEmMinutos(data, dataAgora);
            if (minutos > 0) {
...
var NotificacaoItem = /** @class */ (function () {
    function NotificacaoItem(hostRef) {
        ...
        this.onClick = function (event) {
            event.preventDefault();
            var payload = {
                id: _this.identificador
            };
            if (_this.isLida()) {
                _this.notificacaoNaoLida.emit(payload);
                return;
            }
            if (!isNill(_this.resultadoLink)) {
                payload.url = _this.resultadoLink.href;
                payload.target = _this.getLinkTarget(_this.resultadoLink);
            }
            _this.notificacaoLida.emit(payload);
        };
    }
    NotificacaoItem.prototype.isLida = function () {
        return this.tipo === TipoNotificacao.Lida;
    };
    NotificacaoItem.prototype.isOrigemUsuario = function () {
        return /^user/.test(this.origem);
    };
    NotificacaoItem.prototype.isOrigemSistema = function () {
        return /^system/.test(this.origem);
    };
    NotificacaoItem.prototype.getClassIcone = function () {
        if (!isNill(this.icone)) {
            return this.icone;
        }
    ...
    NotificacaoItem.prototype.getSistema = function () {
        if (this.isOrigemSistema()) {
            return this.origem.split('@')[1];
        }
    };
    NotificacaoItem.prototype.isProgressoEmAndamento = function () {
        return this.isProgresso() && this.isProgressoVisualizado();
    };
    NotificacaoItem.prototype.isProgresso = function () {
        return this.prioridade === 1;
    };
    NotificacaoItem.prototype.isProgressoVisualizado = function () {
        return this.status === 'OPEN';
    };
    NotificacaoItem.prototype.getPercentualProgressoStyle = function () {
        return {
            width: (this.percentualProgresso === null ? 100 : this.percentualProgresso) + "%"
        };
    };
    NotificacaoItem.prototype.getTitleNotificacao = function () {
        if (this.isLida()) {
            return;
        }
        return this.possuiLinkResultado() ? this.getTitleLinkResultado() : 'Marcar como lido';
    };
    NotificacaoItem.prototype.possuiLinkResultado = function () {
        return Boolean(this.resultadoLink);
    };
    NotificacaoItem.prototype.getTitleLinkResultado = function () {
        return this.resultadoLink.title;
    };
    NotificacaoItem.prototype.possuiLinkResultadoParaExibir = function () {
        return this.possuiLinkResultado() && !this.isProgressoEmAndamento();
    };
    NotificacaoItem.prototype.possuiLinkAcompanharParaExibir = function () {
        return this.isProgressoVisualizado() && this.possuiLinkProgresso();
    };
    NotificacaoItem.prototype.possuiLinkProgresso = function () {
        return Boolean(this.acompanharLink);
    };
    NotificacaoItem.prototype.possuiLinkCancelarParaExibir = function () {
        return this.possuiLinkCancelar() && this.isProgressoVisualizado();
    };
    NotificacaoItem.prototype.possuiLinkCancelar = function () {
        return Boolean(this.cancelamentoLink);
    };
    NotificacaoItem.prototype.getLinkTarget = function (link) {
        switch (link.target) {
            case 'SELF':
                return '_self';
            case 'BLANK':
    ...
    NotificacaoItem.prototype.render = function () {
        return (h("div", { onClick: this.onClickPainel, title: this.getTitleNotificacao(), class: "notificacao " + (!this.isLida() && !this.isProgressoEmAndamento() ? 'notificacao--unread' : '') }, h("div", { class: "notificacao__body" }, h("div", { class: "icon" }, this.isOrigemUsuario() ?
            h("bth-icone", { icone: "account" }) :
            h("bth-icone", { icone: this.getClassIcone(), title: getIconeTitle(this.getSistema()) })), h("p", { class: "mensagem" }, this.texto), !this.isProgressoEmAndamento() && (h("a", { href: "", title: "Marcar como " + (!this.isLida() ? 'lido' : 'não lido'), onClick: this.onClick }, h("bth-icone", { class: "marcar-leitura__toggler", icone: !this.isLida() ? 'email-open-outline' : 'email-outline' })))), this.isProgressoEmAndamento() && (h("div", { class: "notificacao__progress " + (this.possuiProgresso ? 'notificacao__progress--success' : 'notificacao__progress--indeterminate') }, this.possuiProgresso && (h("div", { class: "notificacao__progress__percent" }, this.percentualProgresso === null ? 0 : this.percentualProgresso, "%")), h("div", { class: "notificacao__progress__bar", style: this.getPercentualProgressoStyle() }))), h("div", { class: "notificacao__footer" }, this.possuiLinkResultadoParaExibir() && (h("a", { href: this.resultadoLink.href, title: this.resultadoLink.title, target: this.getLinkTarget(this.resultadoLink), rel: "noreferrer" }, this.resultadoLink.label)), this.possuiLinkAcompanharParaExibir() && (h("a", { href: this.acompanharLink.href, title: this.acompanharLink.title, target: this.getLinkTarget(this.acompanharLink), rel: "noreferrer" }, "Acompanhar")), this.possuiLinkAcompanharParaExibir() && this.possuiLinkCancelarParaExibir() && (h("span", null, "\u00A0|\u00A0")), this.possuiLinkCancelarParaExibir() && (h("a", { href: this.cancelamentoLink.href, title: this.cancelamentoLink.title, target: this.getLinkTarget(this.cancelamentoLink), rel: "noreferrer" }, "Cancelar")), this.dataHora && (h("span", { class: "float-right", title: getDataHoraDescrita(this.dataHora) }, getDataHoraDescrita(this.dataHora))))));
    };
    return NotificacaoItem;
}());
NotificacaoItem.style = notificacaoItemCss;
var LIMITE_PAGINACAO = 20;
var MessageType;
...
var NotificacoesService = /** @class */ (function () {
    function NotificacoesService(authorization, notificacoesApi) {
        this.api = new Api(authorization.getAuthorization(), authorization.handleUnauthorizedAccess, notificacoesApi);
    }
    NotificacoesService.prototype.buscar = function (params) {
        if (params === void 0) { params = { offset: 0, limit: 20 }; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('GET', "api/messages/?limit=" + params.limit + "&offset=" + params.offset)];
            });
        });
    };
    NotificacoesService.prototype.buscarNaoLidas = function (params) {
        if (params === void 0) { params = { offset: 0, limit: 20 }; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('GET', "api/messages/unreads/all?limit=" + params.limit + "&offset=" + params.offset)];
            });
        });
    };
    NotificacoesService.prototype.buscarLidas = function (params) {
        if (params === void 0) { params = { offset: 0, limit: 20 }; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('GET', "api/messages/reads?limit=" + params.limit + "&offset=" + params.offset)];
            });
        });
    };
    NotificacoesService.prototype.buscarEmProgresso = function (params) {
        if (params === void 0) { params = { offset: 0, limit: 20 }; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('GET', "api/messages/in-progress?limit=" + params.limit + "&offset=" + params.offset)];
            });
        });
    };
    NotificacoesService.prototype.clearInProgressUnread = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('DELETE', 'api/messages/in-progress/unread')];
            });
        });
    };
    NotificacoesService.prototype.clearUnreads = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('DELETE', 'api/messages/unread?keepInProgress=true')];
            });
        });
    };
    NotificacoesService.prototype.setRead = function (notificationId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('PUT', "api/messages/" + notificationId + "/read")];
            });
        });
    };
    NotificacoesService.prototype.setUnread = function (notificationId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                return [2 /*return*/, this.api.request('PUT', "api/messages/" + notificationId + "/unread")];
            });
        });
    };
    return NotificacoesService;
}());
var sortByDateTime = function (a, b) {
    return a.dateTime < b.dateTime ? 1 : -1;
};
// https://developer.mozilla.org/pt-BR/docs/Web/API/CloseEvent
var CODES_TO_RECONNECT = [1001, 1006];
var RETRY_TIMEOUT_IN_MS = 5000;
var NotificationWebSocket = /** @class */ (function () {
    function NotificationWebSocket(authorization, notificationsWs, refreshTime, listeners, closed) {
        var _this = this;
        if (refreshTime === void 0) { refreshTime = 0; }
        ...
        this.addEventListener('open', function () {
            if (_this.hasStarted()) {
                _this.send({ type: MessageType.RESTARTED, sequence: _this.sequence });
            }
            else {
                _this.send({ type: MessageType.STARTED });
            }
        });
        ...
        this.addEventListener('close', function (event) { return __awaiter(_this, void 0, void 0, function () {
            var retryTime;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        if (!(CODES_TO_RECONNECT.includes(event.code) && !this.closed)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.authorization.handleUnauthorizedAccess()];
                    case 1:
                        _f.sent();
                        retryTime = this.refreshTime;
                        this.refreshTime += RETRY_TIMEOUT_IN_MS;
                        setTimeout(function () { return _this.refresh(); }, retryTime);
                        _f.label = 2;
    ...
    NotificationWebSocket.prototype.addEventListener = function (listener, callback) {
        if (isNill(listener)) {
            return;
        }
    ...
    NotificationWebSocket.prototype.send = function (message) {
        this.webSocket.send(JSON.stringify(message));
    };
    NotificationWebSocket.prototype.hasStarted = function () {
        return this.sequence > 0;
    };
    NotificationWebSocket.prototype.refresh = function () {
        var _this = this;
        this.webSocket = new WebSocket(this.getUrl());
        var _loop_1 = function (listener) {
            if (Object.prototype.hasOwnProperty.call(this_1.listeners, listener)) {
                var listenerCallbacks = this_1.listeners[listener];
                listenerCallbacks.forEach(function (callback) {
                    _this.webSocket.addEventListener(listener, callback);
                });
            }
        };
        var this_1 = this;
    ...
    NotificationWebSocket.prototype.getUrl = function () {
    ...
    NotificationWebSocket.prototype.close = function () {
        this.listeners = {};
        this.closed = true;
...
var Notificacoes = /** @class */ (function () {
    function Notificacoes(hostRef) {
        var _this = this;
        registerInstance(this, hostRef);
        this.conteudoSinalizado = createEvent(this, "conteudoSinalizado", 7);
        this.novaNotificacaoComLink = createEvent(this, "novaNotificacaoComLink", 7);
        ...
        this.tracker = new PromiseTracker(function (active) {
            _this.isBuscandoNotificacoes = active;
        });
        ...
        this.isApiIndisponivel = false;
        this.onClickMarcarTodasComoLidas = function (event) {
            event.preventDefault();
            if (_this.quantidadeEmNaoLidas > 0) {
                _this.notificacoesService.clearUnreads();
                _this.marcarTodasComoLida();
            }
        };
        this.onContentScroll = function (ev) {
            var target = ev.target;
            var isEnd = target.offsetHeight + target.scrollTop >= target.scrollHeight;
            if (isEnd) {
                _this.carregarNotificacoes();
            }
        };
    }
    Notificacoes.prototype.onPainelLateralShow = function (data) {
        if (data.detail.show === true) {
            this.setFiltroNotificacaoPadrao();
        }
    };
    Notificacoes.prototype.onNotificacaoLida = function (event) {
        var _this = this;
        if (!isNill(event.detail.url)) {
            window.open(event.detail.url, event.detail.target);
        }
        var notificacao = this.notificacoesNaoLidas.find(function (naoLida) { return naoLida.id === event.detail.id; });
        ...
        this.notificacoesService
            ...
            .catch(function () {
            _this.marcarNotificacaoComoNaoLida(notificacao);
        });
        this.marcarNotificacaoComoLida(notificacao);
    };
    Notificacoes.prototype.onNotificacaoNaoLida = function (event) {
        var _this = this;
        var notificacao = this.notificacoesLidas.find(function (naoLida) { return naoLida.id === event.detail.id; });
        if (isNill(notificacao)) {
            return;
        }
        this.notificacoesService
            ...
            .catch(function () {
            _this.marcarNotificacaoComoLida(notificacao);
        });
        this.marcarNotificacaoComoNaoLida(notificacao);
    };
    Notificacoes.prototype.onNavbarPillItemClicked = function (data) {
        var identificador = data.detail.identificador;
        this.setFiltroNotificacao(TipoNotificacao[identificador]);
    };
    Notificacoes.prototype.connectedCallback = function () {
        this.inicializarServices();
    };
    Notificacoes.prototype.disconnectedCallback = function () {
        if (!isNill(this.websocket)) {
            this.websocket.close();
        }
    };
    Notificacoes.prototype.onChangeQuantidadeTotalNaoLidas = function (novoValor) {
        var event = {
            possui: true,
            origem: 'notificacoes',
    ...
    Notificacoes.prototype.onChangeApiRelatedProperties = function () {
        if (!isNill(this.websocket)) {
            this.websocket.close();
        }
        this.inicializarServices();
    };
    Notificacoes.prototype.inicializarServices = function () {
        if (this.isConfiguracaoApiInconsistente()) {
    ...
    Notificacoes.prototype.isConfiguracaoApiInconsistente = function () {
    ...
    Notificacoes.prototype.setFiltroNotificacaoPadrao = function () {
    ...
    Notificacoes.prototype.getNotificacoesApi = function () {
        var _a, _b, _c, _d, _e;
    ...
    Notificacoes.prototype.getNotificacoesWs = function () {
        var _a, _b, _c, _d, _e;
    ...
    Notificacoes.prototype.inicializarWebSocket = function () {
        var _this = this;
        this.websocket = new NotificationWebSocket(this.authorization, this.getNotificacoesWs());
        this.websocket.addEventListener('message', function (event) {
            _this.isApiIndisponivel = false;
            if (/type/.test(event.data)) {
                var message = JSON.parse(event.data);
                switch (message.type) {
                    case MessageType.STARTED:
                        _this.onWebsocketStarted(message);
                        break;
                    case MessageType.NEW_NOTIFICATIONS:
                        _this.onWebsocketNewNotifications(message);
                        break;
                    case MessageType.READ_ACTION:
                        _this.onWebsocketReadAction(message);
                        break;
                }
            }
        });
    ...
    Notificacoes.prototype.onWebsocketStarted = function (message) {
    ...
    Notificacoes.prototype.onWebsocketNewNotifications = function (message) {
        var _this = this;
        message.notifications.forEach(function (notification) {
            _this.addNovaMensagem(notification);
        });
    };
    Notificacoes.prototype.addNovaMensagem = function (message) {
    ...
    Notificacoes.prototype.addMensagemNaoLida = function (message) {
    ...
    Notificacoes.prototype.addMensagemAltaPrioridade = function (message) {
    ...
    Notificacoes.prototype.removerDeTodasListas = function (id) {
        this.notificacoesEmProgresso = this.notificacoesEmProgresso.filter(function (emProgresso) { return emProgresso.id !== id; });
        this.notificacoesLidas = this.notificacoesLidas.filter(function (lidas) { return lidas.id !== id; });
        this.notificacoesNaoLidas = this.notificacoesNaoLidas.filter(function (naoLidas) { return naoLidas.id !== id; });
    };
    Notificacoes.prototype.onWebsocketReadAction = function (message) {
    ...
    Notificacoes.prototype.marcarTodasComoLida = function () {
        this.quantidadeTotalNaoLidas -= this.quantidadeEmNaoLidas;
        this.quantidadeEmNaoLidas = 0;
        this.resetarListasNotificacoes();
    };
    Notificacoes.prototype.resetarListasNotificacoes = function () {
        this.notificacoesNaoLidas = [];
        this.notificacoesLidas = [];
        this.notificacoesEmProgresso = [];
        this.carregouTodasEmProgresso = false;
    ...
    Notificacoes.prototype.marcarTodasEmProgressoComoLida = function () {
        this.quantidadeTotalNaoLidas -= this.quantidadeEmProgressoNaoLidas;
        this.quantidadeEmProgressoNaoLidas = 0;
    };
    Notificacoes.prototype.marcarNotificacaoComoLida = function (notificacao) {
        var novasNotificacoesNaoLidas = this.notificacoesNaoLidas.filter(function (item) {
    ...
    Notificacoes.prototype.marcarNotificacaoComoNaoLida = function (notificacao) {
        var novasNotificacoesLidas = this.notificacoesLidas.filter(function (item) {
            return notificacao.id !== item.id;
        });
    ...
    Notificacoes.prototype.carregarNotificacoesNaoLidas = function () {
        var _this = this;
        if (this.isConfiguracaoApiInconsistente()) {
            return;
        }
        var promise = this.notificacoesService
            .buscarNaoLidas(this.getPaginationQueryParams(this.notificacoesNaoLidas.length))
            .then(function (notificacoesNaoLidas) {
            _this.carregouNaoLidas = true;
            _this.notificacoesNaoLidas = _this.notificacoesNaoLidas.concat(notificacoesNaoLidas.content).sort(sortByDateTime);
            _this.carregouTodasNaoLidas = !notificacoesNaoLidas.hasNext;
            _this.quantidadeEmNaoLidas = _this.notificacoesNaoLidas.length + _this.quantidadeEmProgressoNaoLidas;
            _this.quantidadeTotalNaoLidas = _this.quantidadeEmNaoLidas + _this.quantidadeEmProgressoNaoLidas;
        })
            .catch(function () {
            _this.isApiIndisponivel = true;
        });
    ...
    Notificacoes.prototype.carregarNotificacoesLidas = function () {
        var _this = this;
        if (this.isConfiguracaoApiInconsistente()) {
            return;
        }
        var promise = this.notificacoesService
            ...
            .then(function (notificacoesLidas) {
            _this.carregouLidas = true;
            _this.notificacoesLidas = _this.notificacoesLidas.concat(notificacoesLidas.content).sort(sortByDateTime);
            _this.carregouTodasLidas = !notificacoesLidas.hasNext;
        })
            .catch(function () {
            _this.isApiIndisponivel = true;
        });
    ...
    Notificacoes.prototype.carregarNotificacoesEmProgresso = function () {
        var _this = this;
        if (this.isConfiguracaoApiInconsistente()) {
            return;
        }
        var promise = this.notificacoesService
            ...
            .then(function (notificacoesEmProgresso) {
            _this.carregouEmProgresso = true;
            _this.notificacoesEmProgresso = _this.notificacoesEmProgresso.concat(notificacoesEmProgresso.content).sort(sortByDateTime);
            _this.carregouTodasEmProgresso = !notificacoesEmProgresso.hasNext;
        })
            .catch(function () {
            _this.isApiIndisponivel = true;
        });
    ...
    Notificacoes.prototype.getPaginationQueryParams = function (offset) {
        return { offset: offset, limit: LIMITE_PAGINACAO };
    };
    Notificacoes.prototype.getOpcaoFiltroAtivo = function () {
        return this.filtros.filter(function (filtro) { return filtro.ativo === true; })[0];
    };
    Notificacoes.prototype.setFiltroNotificacao = function (filtro) {
        this.filtros = this.filtros.map(function (_filtro) {
            _filtro.ativo = _filtro.id === filtro;
            return _filtro;
        });
        var filtroAtivo = this.getOpcaoFiltroAtivo();
    ...
    Notificacoes.prototype.hasNotificacoes = function () {
    ...
    Notificacoes.prototype.getNotificacoesPorFiltroAtivo = function () {
        if (this.isFiltroPorLidas()) {
    ...
    Notificacoes.prototype.isFiltroPorLidas = function () {
        return this.getOpcaoFiltroAtivo().id === TipoNotificacao.Lida;
    };
    Notificacoes.prototype.isFiltroPorNaoLidas = function () {
        return this.getOpcaoFiltroAtivo().id === TipoNotificacao.NaoLida;
    };
    Notificacoes.prototype.isFiltroPorProgresso = function () {
        return this.getOpcaoFiltroAtivo().id === TipoNotificacao.Progresso;
    };
    Notificacoes.prototype.carregarNotificacoes = function () {
    ...
    Notificacoes.prototype.renderLoader = function () {
        if (!this.isBuscandoNotificacoes) {
            return;
        }
        var isPageLoader = this.getNotificacoesPorFiltroAtivo().length <= 0;
        return (h("div", { class: "loader " + (isPageLoader ? 'loader--full-page' : 'loader--list-bottom') }, h("bth-loader", null)));
    };
    Notificacoes.prototype.getHeightPainelNotificacoes = function () {
        var style = {};
    ...
    Notificacoes.prototype.render = function () {
        var _this = this;
        var notificacoesConteudo = function () { return [
            h("div", null, !_this.isApiIndisponivel && (h("bth-navbar-pill-group", { descricao: "Notifica\u00E7\u00F5es" }, _this.filtros.map(function (filtro) { return (h("bth-navbar-pill-item", { key: filtro.id.toString(), identificador: filtro.id.toString(), icone: filtro.icone, descricao: filtro.descricao, ativo: filtro.ativo, totalizador: filtro.id === TipoNotificacao.NaoLida ? _this.quantidadeEmNaoLidas : (filtro.id === TipoNotificacao.Progresso ? _this.quantidadeEmProgressoNaoLidas : 0), showTotalizador: !_this.isBuscandoNotificacoes })); }))), !_this.isApiIndisponivel && _this.hasNotificacoes() && _this.isFiltroPorNaoLidas() && !_this.isBuscandoNotificacoes && (h("div", { class: "text-right" }, h("a", { class: "link", href: "", title: "Marcar todas como lidas", onClick: _this.onClickMarcarTodasComoLidas }, "Marcar todas como lidas"))), h("div", { style: _this.getHeightPainelNotificacoes(), class: "painel-notificacoes", onScroll: _this.onContentScroll }, !_this.isApiIndisponivel && !_this.hasNotificacoes() && !_this.isBuscandoNotificacoes && (h("div", { class: "empty-notificacoes" }, h("div", { class: "empty-notificacoes__img" }), h("h4", null, "N\u00E3o h\u00E1 notifica\u00E7\u00F5es por aqui"))), _this.isApiIndisponivel && !_this.isBuscandoNotificacoes && (h("div", { class: "empty-notificacoes" }, h("div", { class: "empty-notificacoes-inconsistency" }), h("h4", null, "As notifica\u00E7\u00F5es est\u00E3o temporariamente indispon\u00EDveis"))), !_this.isApiIndisponivel && (h("ul", { class: "notificacoes-lista" }, _this
                .getNotificacoesPorFiltroAtivo()
                .map(function (notificacao) { return (h("li", { key: notificacao.id }, h("bth-notificacao-item", { identificador: notificacao.id, tipo: _this.getOpcaoFiltroAtivo().id, texto: notificacao.text, dataHora: notificacao.dateTime, origem: notificacao.source, icone: notificacao.icon, resultadoLink: notificacao.link, cancelamentoLink: notificacao.cancellationLink, acompanharLink: notificacao.trackingLink, possuiProgresso: notificacao.progress, percentualProgresso: notificacao.percentage, status: notificacao.status, prioridade: notificacao.priority }))); }))), _this.renderLoader()))
        ]; };
        if (this.onlyContent)
            return (h("div", null, notificacoesConteudo()));
        return (h("bth-menu-ferramenta", { descricao: "Notifica\u00E7\u00F5es", tituloPainelLateral: "Notifica\u00E7\u00F5es" }, h("bth-menu-ferramenta-icone", { slot: "menu_item_mobile", icone: "bell", contador: this.quantidadeTotalNaoLidas, mobile: true }), h("span", { slot: "menu_descricao_mobile", class: "descricao-mobile" }, "Notifica\u00E7\u00F5es"), h("bth-menu-ferramenta-icone", { slot: "menu_item_desktop", icone: "bell", contador: this.quantidadeTotalNaoLidas }), h("section", { slot: "conteudo_painel_lateral" }, notificacoesConteudo())));
    };
    Object.defineProperty(Notificacoes.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Notificacoes, "watchers", {
        get: function () {
            return {
...
var Novidades = /** @class */ (function () {
    function class_6(hostRef) {
        ...
        this.onClickMarcarTodasComoLidas = function (event) {
            event.preventDefault();
            _this.novidades
                .filter(function (novidade) { return !_this.novidadesService.isLida(novidade.id); })
                .forEach(function (novidade) { return _this.novidadesService.marcarComoLida(novidade.id); });
            forceUpdate(_this);
            _this.atualizarIndicadorConteudoSinalizado();
        };
    }
    class_6.prototype.onPainelLateralShow = function (data) {
        if (data.detail.show === true) {
            this.setFiltroNovidadePadrao();
        }
    };
    class_6.prototype.onNovidadeLida = function (data) {
        var _f = data.detail, id = _f.id, url = _f.url;
        this.novidadesService.marcarComoLida(id);
        window.open(url, '_blank');
        forceUpdate(this);
        this.atualizarIndicadorConteudoSinalizado();
    };
    class_6.prototype.onNovidadeNaoLida = function (data) {
        var id = data.detail.id;
        this.novidadesService.marcarComoNaoLida(id);
        forceUpdate(this);
        this.atualizarIndicadorConteudoSinalizado();
    };
    class_6.prototype.onNavbarPillItemClicked = function (data) {
        var identificador = data.detail.identificador;
        this.setFiltroNovidade(FiltroNovidade[identificador]);
    };
    class_6.prototype.watchAuthorization = function () {
        this.handleBuscar();
    };
    class_6.prototype.watchNovidadesApi = function () {
    ...
    class_6.prototype.handleBuscar = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        this.stopPollingListener();
                        return [4 /*yield*/, this.buscar()];
                    case 1:
                        _f.sent();
    ...
    class_6.prototype.stopPollingListener = function () {
    ...
    class_6.prototype.startPollingListener = function () {
        var _this = this;
        this.pollingHandler = setInterval(function () { return _this.buscar(); }, POLLING_INTERVAL);
    };
    class_6.prototype.buscar = function () {
        return __awaiter(this, void 0, void 0, function () {
            var novidades, _a_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.novidadesService.buscar()];
                    case 2:
                        novidades = _f.sent();
                        this.novidades = __spreadArrays(novidades.sort(sortByDataInicial));
    ...
    class_6.prototype.isConfiguracaoApiInconsistente = function () {
    ...
    class_6.prototype.setFiltroNovidadePadrao = function () {
        this.setFiltroNovidade(FiltroNovidade.NaoLida);
    };
    class_6.prototype.atualizarIndicadorConteudoSinalizado = function () {
        var event = {
            possui: true,
            origem: 'novidades'
        };
    ...
    class_6.prototype.getNovidadesApi = function () {
    ...
    class_6.prototype.setFiltroNovidade = function (novoFiltro) {
        this.filtros = this.filtros.map(function (filtro) {
            filtro.ativo = filtro.id === novoFiltro;
            return filtro;
        });
    };
    class_6.prototype.getQtdNaoLidas = function () {
        var _this = this;
        return this.novidades.filter(function (novidade) { return !_this.novidadesService.isLida(novidade.id); }).length;
    };
    class_6.prototype.getQtdLidas = function () {
        var _this = this;
        return this.novidades.filter(function (novidade) { return _this.novidadesService.isLida(novidade.id); }).length;
    };
    class_6.prototype.getOpcaoFiltroAtivo = function () {
        return this.filtros.filter(function (filtro) { return filtro.ativo === true; })[0];
    };
    class_6.prototype.isFiltroPorLidas = function () {
        return this.getOpcaoFiltroAtivo().id === FiltroNovidade.Lida;
    };
    class_6.prototype.isFiltroPorNaoLidas = function () {
        return this.getOpcaoFiltroAtivo().id === FiltroNovidade.NaoLida;
    };
    class_6.prototype.isEmptyStateVisible = function () {
    ...
    class_6.prototype.renderLoader = function () {
        if (!this.isBuscandoNovidades) {
            return;
        }
        var isPageLoader = this.novidades.length <= 0;
        return (h("div", { class: "loader " + (isPageLoader ? 'loader--full-page' : 'loader--list-bottom') }, h("bth-loader", null)));
    };
    class_6.prototype.render = function () {
        var _this = this;
        var totalNaoLida = this.getQtdNaoLidas();
        var totalLida = this.getQtdLidas();
        return (h("bth-menu-ferramenta", { descricao: "Novidades", tituloPainelLateral: "Novidades" }, h("bth-menu-ferramenta-icone", { slot: "menu_item_mobile", icone: "gift", contador: totalNaoLida, mobile: true }), h("span", { slot: "menu_descricao_mobile", class: "descricao-mobile" }, "Novidades"), h("bth-menu-ferramenta-icone", { slot: "menu_item_desktop", icone: "gift", contador: totalNaoLida }), h("section", { slot: "conteudo_painel_lateral" }, !this.isApiIndisponivel && (h("bth-navbar-pill-group", { descricao: "Novidades" }, this.filtros.map(function (filtro) { return (h("bth-navbar-pill-item", { key: filtro.id.toString(), identificador: filtro.id.toString(), icone: filtro.icone, descricao: filtro.descricao, ativo: filtro.ativo, totalizador: filtro.id === FiltroNovidade.NaoLida ? totalNaoLida : totalLida, showTotalizador: !_this.isBuscandoNovidades })); }))), totalNaoLida !== 0 && this.isFiltroPorNaoLidas() && (h("div", { class: "marcar-todas" }, h("a", { href: "", onClick: this.onClickMarcarTodasComoLidas }, "Marcar todas como lidas"))), h("div", { class: "painel-novidades" }, this.isEmptyStateVisible() && !this.isBuscandoNovidades && (h("section", { class: "empty-state-container" }, h("div", { class: "sem-registros" }), h("h4", null, "N\u00E3o h\u00E1 novidades por aqui"))), this.isApiIndisponivel && !this.isBuscandoNovidades && (h("section", { class: "empty-state-container" }, h("div", { class: "indisponivel" }), h("h4", null, "As novidades est\u00E3o temporariamente indispon\u00EDveis"))), !this.isApiIndisponivel && (h("ul", { class: "lista" }, this.isFiltroPorLidas() && (this.novidades.map(function (novidade) {
            if (_this.novidadesService.isLida(novidade.id)) {
                return (h("li", { key: novidade.id }, h("bth-novidade-item", { identificador: novidade.id, titulo: novidade.titulo, mensagem: novidade.mensagem, url: novidade.url, dataHora: novidade.dataInicial, isLida: true })));
            }
        })), this.isFiltroPorNaoLidas() && (this.novidades.map(function (novidade) {
            if (!_this.novidadesService.isLida(novidade.id)) {
                return (h("li", { key: novidade.id }, h("bth-novidade-item", { identificador: novidade.id, titulo: novidade.titulo, mensagem: novidade.mensagem, url: novidade.url, dataHora: novidade.dataInicial, isLida: false })));
            }
        })))), this.renderLoader()))));
    };
...
var Utilitarios = /** @class */ (function () {
    function Utilitarios(hostRef) {
        ...
        this.onClick = function (event, utilitario) {
            ...
            _this.opcaoUtilitarioSelecionada.emit(eventPayload);
        };
    }
    Utilitarios.prototype.render = function () {
        var _this = this;
        return (h("bth-menu-ferramenta", { descricao: "Utilit\u00E1rios", tituloPainelLateral: "Utilit\u00E1rios" }, h("bth-menu-ferramenta-icone", { slot: "menu_item_desktop", icone: "view-grid" }), h("bth-menu-ferramenta-icone", { slot: "menu_item_mobile", icone: "view-grid", mobile: true }), h("span", { slot: "menu_descricao_mobile", class: "descricao-mobile" }, "Utilit\u00E1rios"), h("div", { slot: "conteudo_painel_lateral", class: "painel-utilitarios" }, this.utilitarios && (h("ul", null, this.utilitarios.map(function (utilitario, index) {
            return (h("li", { key: index, id: "utilitario_item_" + index }, h("button", { onClick: function (event) { return _this.onClick(event, utilitario); }, class: "\n                          painel-utilitarios__card\n                          painel-utilitarios__card--bordered block-ellipsis\n                          " + (utilitario.possuiPermissao ? 'painel-utilitarios__card--clickable' : 'painel-utilitarios__card--disabled') + "\n                        ", title: utilitario.possuiPermissao ? utilitario.nome : MSG_SEM_PERMISSAO_RECURSO, "aria-label": "Acessar o utilit\u00E1rio " + utilitario.nome, "aria-disabled": "" + !utilitario.possuiPermissao, disabled: !utilitario.possuiPermissao }, h("bth-icone", { icone: utilitario.icone, title: utilitario.nome }), h("span", { class: "descricao block-ellipsis" }, utilitario.nome))));
        }))))));
    };
    Object.defineProperty(Utilitarios.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
...
export { Ajuda as bth_ajuda, App as bth_app, Avatar as bth_avatar, ContaUsuario as bth_conta_usuario, Icone as bth_icone, Loader as bth_loader, MarcaProduto as bth_marca_produto, MenuFerramenta as bth_menu_ferramenta, MenuFerramentaIcone as bth_menu_ferramenta_icone, MenuHorizontalItem as bth_menu_horizontal_item, MenuPainelLateral as bth_menu_painel_lateral, MenuVerticalItem as bth_menu_vertical_item, NavbarPillGroup as bth_navbar_pill_group, NavbarPillItem as bth_navbar_pill_item, NotificacaoItem as bth_notificacao_item, Notificacoes as bth_notificacoes, NovidadeItem as bth_novidade_item, Novidades as bth_novidades, Utilitarios as bth_utilitarios };
